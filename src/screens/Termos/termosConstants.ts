export const TERMS_HERO = {
  ...
  dateLabel: "Última atualização: 19/05/2026",
  intro:
...
export const TERMS_SECTIONS = [
  ...
  {
    id: 8,
    title: "Da Participação em Comunidades e Regras de Convivência",
    defaultOpen: false,
  },
  { id: 9, title: "Do Tratamento de Dados Pessoais", defaultOpen: false },
  {
    id: 10,
    title: "Conteúdos, Propriedade Intelectual e Licença de Uso",
    defaultOpen: false,
  },
  { id: 11, title: "Das Limitações de Responsabilidade", defaultOpen: false },
  { id: 12, title: "Das Alterações dos Termos", defaultOpen: false },
  { id: 13, title: "Da Suspensão e Encerramento", defaultOpen: false },
  { id: 14, title: "Da Isenção de Garantias", defaultOpen: false },
  { id: 15, title: "Das Comunicações", defaultOpen: false },
  {
    id: 16,
    title: "Da Legislação Aplicável e do Foro",
    defaultOpen: false,
  },
] as const;
